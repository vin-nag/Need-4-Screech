...
const CEnemyAI = (enemy_type, currentRoam, roamDistance, aggro_time=5000, detection_distance=1000, player_detected=false, show=false, playerPosition) => ({name: "CEnemyAI", enemy_type, currentRoam, roamDistance, aggro_time, detection_distance, player_detected, show, playerPosition});
